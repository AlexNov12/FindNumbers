...
class SelectTimeViewController: UIViewController {
    ...
    @IBOutlet weak var tableView: UITableView!{
        didSet{
            ...
            tableView?.delegate = self //позволяет отслеживать действия с таблицей
        }
    }
...
extension SelectTimeViewController:UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        navigationController?.popViewController(animated: true) //возвращает назад на экран главный
    }
